...
![Dashboard Preview](Dashboard_CLV.png)
...
|---------|---------------|---------------|---------------|----------|
| Champions | 22% | £6,000 | 11 orders | Protect & reward — VIP loyalty program |
| Loyal Customers | 23% | £1,500 | 4 orders | Upsell & deepen — referral program |
| At Risk | 15% | £1,200 | 3.5 orders | Urgent win-back — reactivation campaign |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue)](https://www.linkedin.com/in/ritesh-kumar-yadav-957561302/)
